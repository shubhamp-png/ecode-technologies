          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="animate-fadeInLeft">
              ...
              <div className="space-y-6">
                {[
                  { icon: Mail, title: 'Email', info: 'info@devhirepro.com', color: 'from-yellow-400 to-orange-500' },
                  { icon: Phone, title: 'Phone / WhatsApp', info: '+1 (555) 123-4567', color: 'from-green-400 to-green-600' },
                  { icon: Globe, title: 'Website', info: 'www.devhirepro.com', color: 'from-blue-400 to-blue-600' }
                ].map((item, index) => {
                  const Icon = item.icon;
                  return (
                    <div 
      ...
      <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-8 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-300 mb-2">
            © 2026 DevHire Pro | Dedicated Developers & Resource Hiring Partner
          </p>
          <div className="flex items-center justify-center gap-2 text-gray-400">
            Made with <Heart className="text-red-500 animate-pulse" size={16} /> for businesses worldwide
          </div>
        </div>
      </footer>
