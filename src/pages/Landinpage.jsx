...
import { 
  ...
  GitBranch, Coffee, Heart, Star, MessageSquare, Send
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2">
      ...
      <section id="home" className="pt-32 pb-20 px-4 relative">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-200 rounded-full blur-3xl opacity-20 animate-floatDelay"></div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInLeft">
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-600 px-4 py-2 rounded-full text-sm font-semibold mb-6 animate-bounce">
                <Rocket size={18} />
                Your Trusted IT Partner
              </div>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Accelerate Your
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent animate-gradient"> Digital Growth</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Leverage exceptional capabilities and resources to develop tailored software, web & mobile applications, and cloud solutions that drive business transformation.
              </p>
              <div className="flex flex-wrap gap-4">
                <button 
                  onClick={() => scrollToSection('services')}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
                >
                  Explore Services 
                ...
                <button 
                  ...
                  className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 hover:scale-105 transition-all duration-300"
                >
                  Contact Us
                </button>
              </div>
            ...
            <div className="relative animate-fadeInRight">
              <div className="relative z-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-shadow duration-300">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-center mb-3">
                    <div className="bg-gradient-to-br from-blue-500 to-purple-600 w-12 h-12 rounded-full flex items-center justify-center group-hover:rotate-12 transition-transform">
      ...
      <section id="about" className="py-20 px-4 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">About TechSolutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Empowering businesses with cutting-edge technology solutions and on-demand tech talent
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fadeInLeft">
              ...
              <p className="text-gray-600 mb-6">
                With over a decade of experience in software development, we transform ideas into powerful digital solutions. Our team combines technical expertise with strategic thinking to deliver exceptional results that drive business growth.
              </p>
                ...
                return (
                  ...
                  >
                    <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-blue-500">
                      <div className="bg-gradient-to-br from-blue-500 to-purple-600 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    ...
                    {index < processSteps.length - 1 && (
                      <div className="hidden md:block absolute top-1/2 -right-3 w-6 h-0.5 bg-gradient-to-r from-blue-500 to-purple-600"></div>
                    )}
                  </div>
                );
              })}
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-blue-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Choose TechSolutions</h2>
      ...
      <section id="hire-developers" className="py-20 px-4 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fadeInUp">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Hire <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Dedicated Developers</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Scale your team with pre-vetted experts ready to accelerate your projects
            </p>
          </div>

          {/* Tabs for categories */}
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {['All', 'Frontend', 'Backend', 'Mobile', 'Full Stack', 'Cloud & DevOps'].map((tab, index) => (
              <button
                key={index}
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-6 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                      ...
                      <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-transform">
                        <DevIcon className="text-white" size={32} />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-500 mb-3 uppercase tracking-wide">Key Skills</h4>
                      <div className="flex flex-wrap gap-2">
                        {['Expert', 'Production Ready', 'Scalable Solutions'].map((skill, i) => (
                    ...
                    <div className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-500 mb-3 uppercase tracking-wide">Availability</h4>
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm font-semibold text-gray-500 mb-3 uppercase tracking-wide">Engagement Models</h4>
                    ...
                    <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2 group">
                      Hire {dev.name} Developer
          ...
          <div className="bg-white rounded-3xl shadow-xl p-12 mb-12">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Why Hire From TechSolutions?</h3>
              <p className="text-gray-600 max-w-2xl mx-auto">
                We provide more than just developers - we offer comprehensive solutions for your team growth
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: 'Rigorous screening process ensuring top 3% developers',
                  color: 'from-blue-500 to-blue-600'
                },
                {
                  icon: Zap,
                  title: 'Quick Onboarding',
                  desc: 'Start within 48 hours with seamless integration',
                  color: 'from-purple-500 to-purple-600'
                },
                {
                  icon: Target,
                  title: 'Perfect Match',
                  desc: 'Skill-based matching aligned with your project needs',
                  color: 'from-green-500 to-green-600'
                },
                {
                  icon: TrendingUp,
                  title: 'Flexible Scaling',
                  desc: 'Scale up or down based on your requirements',
                ...
                return (
                  <div key={index} className="text-center group">
                    <div className={`w-16 h-16 bg-gradient-to-br ${benefit.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 group-hover:rotate-6 transition-transform shadow-lg`}>
            ...
            {[
              {
                ...
                title: 'Hourly Hiring',
                price: 'From $25/hr',
                features: ['Pay for actual hours', 'Flexible scheduling', 'No long-term commitment', 'Ideal for short tasks'],
                recommended: false
              },
              {
                icon: Users,
                ...
                price: 'From $3,500/mo',
                features: ['Dedicated resource', 'Full-time commitment', '160 hours/month', 'Best for projects'],
                recommended: true
              },
              {
                icon: Briefcase,
                title: 'Fixed Price',
                price: 'Custom Quote',
                features: ['Project-based pricing', 'Defined scope', 'Milestone payments', 'Complete ownership'],
                recommended: false
              }
            ].map((model, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-14 h-14 bg-gradient-to-br ${model.recommended ? 'from-blue-600 to-purple-600' : 'from-gray-400 to-gray-500'} rounded-xl flex items-center justify-center mb-4`}>
                    <ModelIcon className="text-white" size={24} />
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 animate-fadeInRight">
              ...
              <form className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all"
                ></textarea>
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-4 rounded-lg font-semibold hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2 group">
                  Send Message
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-center md:text-left">
              &copy; 2026 TechSolutions. All rights reserved.
            </p>
            <div className="flex items-center gap-2 text-gray-400">
              Made with <Heart className="text-red-500 animate-pulse" size={16} /> by TechSolutions Team
            </div>
          </div>
        </div>
      </footer>
