...
// export default function TechSolutionsWebsite() {
...
//               <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-orange-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
...
//                 >
//                   {section.replace('-', ' ')}
//                   <span className={`absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-indigo-600 to-orange-500 transform transition-transform duration-300 ${
//                     activeSection === section ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
//                   }`}></span>
//                 </button>
//               ))}
//               <button className="bg-gradient-to-r from-indigo-600 to-orange-500 text-white px-6 py-2 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2">
...
//                 Accelerate Your
//                 <span className="bg-gradient-to-r from-indigo-600 to-orange-500 bg-clip-text text-transparent animate-gradient"> Digital Growth</span>
//               </h1>
...
//                   className="bg-gradient-to-r from-indigo-600 to-orange-500 text-white px-8 py-4 rounded-full font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
//                 >
//                   Explore Services 
...
//                     </div>
//                   </div>
//                   <div className="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-orange-500 bg-clip-text text-transparent mb-2">
...
//               About Us
//             </div>
//             <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">About Ecode Technologies</h2>
...
//       {/* Why Choose Us */}
//       <section className="py-20 px-4 bg-gradient-to-br from-indigo-600 to-orange-500 text-white relative overflow-hidden">
...
//                 >
//                   <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-orange-500 rounded-lg mx-auto mb-4 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-transform">
...
//           <div className="bg-gradient-to-r from-indigo-600 to-orange-500 rounded-3xl p-12 text-white relative overflow-hidden">
...
//                   className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all"
//                 ></textarea>
//                 <button className="w-full bg-gradient-to-r from-indigo-600 to-orange-500 text-white px-6 py-4 rounded-lg font-semibold hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2 group">
//                   Send Message
...
//                 <div className="w-10 h-10 bg-gradient-to-br from-indigo-600 to-orange-500 rounded-lg flex items-center justify-center">
//                   <Code className="text-white" size={24} />
//                 </div>
...
//               &copy; 2026 Ecode Technologies. All rights reserved.
//             </p>
